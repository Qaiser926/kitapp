...
class sportMerchandisePage extends StatefulWidget {

  @override
  _sportMerchandisePageState createState() => _sportMerchandisePageState();
}

class _sportMerchandisePageState extends State<sportMerchandisePage> {

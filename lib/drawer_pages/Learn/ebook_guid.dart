...
class ebookGuidPagePage extends StatefulWidget {

  @override
  _ebookGuidPagePageState createState() => _ebookGuidPagePageState();
}

class _ebookGuidPagePageState extends State<ebookGuidPagePage> {

...
class webinarGuidPage extends StatefulWidget {

  @override
  _webinarGuidPageState createState() => _webinarGuidPageState();
}

class _webinarGuidPageState extends State<webinarGuidPage> {

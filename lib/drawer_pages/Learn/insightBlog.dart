...
class insightBlogPage extends StatefulWidget {

  @override
  _insightBlogPageState createState() => _insightBlogPageState();
}

class _insightBlogPageState extends State<insightBlogPage> {

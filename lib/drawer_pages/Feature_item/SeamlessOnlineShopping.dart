...
class SeamLessOnlineShopingPage extends StatefulWidget {

  @override
  _SeamLessOnlineShopingPageState createState() => _SeamLessOnlineShopingPageState();
}

class _SeamLessOnlineShopingPageState extends State<SeamLessOnlineShopingPage> {
